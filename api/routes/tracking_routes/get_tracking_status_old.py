            ...
            "content": {
                "application/json": {
                    "example": {
                        ...
                        "api_endpoint": "https://api.example.com/endpoint-tracking",
                        "success_only": True,
...
async def get_tracking_status():
    ...
    """
    return {
        "tracking_enabled": swagger_settings.endpoint_tracking_enabled,
        "client_id": keycloak_settings.client_id,
        "organization": swagger_settings.organization,
        "api_endpoint": swagger_settings.endpoint_tracking_api_url,
        "success_only": True,
        "request_data_tracking": True,
        "message": "Endpoint tracking is active and configured" if swagger_settings.endpoint_tracking_enabled else "Endpoint tracking is disabled"
    }
