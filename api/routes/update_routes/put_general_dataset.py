# api/routes/update_routes/put_general_dataset.py
...
@router.put(
    ...
    summary="Update an existing general dataset",
    description=(
        "Update an existing general dataset in CKAN (full replacement).\n\n"
        "### Path Parameters\n"
        ...
        "```json\n"
        "{\n"
        '    "title": "Updated Research Dataset",\n'
        '    "notes": "Updated description with new information",\n'
        '    "tags": ["research", "climate", "updated"],\n'
        '    "extras": {\n'
...
async def update_general_dataset_endpoint(
    dataset_id: str,
