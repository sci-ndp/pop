...
class ResourceRequest(BaseModel):
    ...
    mimetype: Optional[str] = Field(
        None, description="MIME type of the resource"
    )
    size: Optional[int] = Field(
        None, description="Size of the resource in bytes"
    )
...
class GeneralDatasetRequest(BaseModel):
    ...
    owner_org: str = Field(
        ..., description="Organization ID that owns this dataset"
    )
    ...
    version: Optional[str] = Field(
        None, description="Version of the dataset"
    )
