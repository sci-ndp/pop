...
from api.models.urlrequest_model import (
    URLRequest, FileTypeEnum, StreamProcessingInfo, CSVProcessingInfo,
    TXTProcessingInfo, JSONProcessingInfo, NetCDFProcessingInfo
)
...
class TestURLRequest:
    ...
    def test_url_request_with_edge_case_processing(self):
        ...
        request = URLRequest(
            ...
            processing={
                "delimiter": ",",
                "header_line": 1  # Valid processing
            }
        )
    ...
    def test_url_request_with_custom_file_type(self):
        ...
        request = URLRequest(
            ...
            processing={
                "any_field": "any_value"  # Should be allowed for custom types
            }
        )
